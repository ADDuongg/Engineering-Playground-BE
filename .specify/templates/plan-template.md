...
- [ ] **Learning UX**: Actionable errors; metrics from backend only
- [ ] **Platform vs Playground**: Permanent vs disposable data separated correctly
- [ ] **Simplicity**: No new abstractions without documented need; heavy work async
